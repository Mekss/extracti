...
class KeywordsPostProcessor:
    ...
    @classmethod
    def get_top_keywords_from_articles(cls, filename="data/abcnews-date-text.json",
    ...
    @classmethod
    def post_process_article_keywords(cls, filename="data/abcnews-date-text.json"):
        _articles = JsonLoader.load_json(filename)
        for a in _articles:
...
if __name__ == "__main__":
    ...
    KeywordsPostProcessor.get_top_keywords_from_articles(
        filename="data/abcnews-date-text_post_processed.json",
